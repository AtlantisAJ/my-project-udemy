...
// 1 Вариант
// const isElementInArray = (inputArray, searchElement) => inputArray.some((el) => el === searchElement) ? true : false;

// 2 Вариант
// const isElementInArray = (inputArray, searchElement) => inputArray.some((el) => el === searchElement);
